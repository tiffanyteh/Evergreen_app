...
import com.example.myapplication.CactusList;
import com.example.myapplication.FlowerList;
import com.example.myapplication.PalmTreeList;
import com.example.myapplication.R;
import com.example.myapplication.TreeList;
        ...
        switch (position){
            case 0:{
                ...
                holder.categoryPic.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent i = new Intent(holder.itemView.getContext(),TreeList.class);
            ...
            case 1:{
                ...
                holder.categoryPic.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent i = new Intent(holder.itemView.getContext(), PalmTreeList.class);
                        holder.itemView.getContext().startActivity(i);
                    }
                });
            ...
            case 2:{
                ...
                holder.categoryPic.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent i = new Intent(holder.itemView.getContext(), FlowerList.class);
                        holder.itemView.getContext().startActivity(i);
                    }
                });
            ...
            case 3:{
                ...
                holder.categoryPic.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent i = new Intent(holder.itemView.getContext(), CactusList.class);
                        holder.itemView.getContext().startActivity(i);
                    }
                });
                holder.mainLayout.setBackground(ContextCompat.getDrawable(holder.itemView.getContext(),
